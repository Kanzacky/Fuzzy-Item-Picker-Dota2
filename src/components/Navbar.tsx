...
export default function Navbar() {
    return (
        <nav className="relative z-50 flex flex-col md:flex-row items-center px-[20px] md:px-[60px] py-[20px] gap-[20px] md:gap-[60px]">
            <Link href="/">
                <Image
            ...
            <ul className="flex flex-wrap justify-center md:justify-start gap-[15px] md:gap-[25px] w-full items-center list-none">
                <li>
